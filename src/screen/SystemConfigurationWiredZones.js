...
function SystemConfigurationWired(){
    ...
    function EquipmentCode(){
        var zone = ""
        if (document.getElementById("zone-two") !== null){
            if (document.getElementById("zone-one").style.backgroundColor === "rgb(68, 140, 192)"){
                zone = "1"
            }
            else if (document.getElementById("zone-two").style.backgroundColor === "rgb(68, 140, 192)"){
    ...
    return(
        <div className="screen-style">
            <div className="screen-header">
                <img src={hardwired_icon} className="resize-1 invert-color" alt="" />
                ...
                <div className="config-container">
                    <div className="config-container-scroll">
                        ...
                        <ul className="programming-list">
                            <li><p id="zone-one" tabIndex="0" onClick={() => choseZone("zone-one")}>Wired Zone 001</p></li>
                            <li><p id="zone-two" tabIndex="0" onClick={() => choseZone("zone-two")}>Wired Zone 002</p></li>
                        </ul>
            ...
            <div className="screen-right-settings">
                <Link to="/installer-toolbox/system-configuration/wired/edit" style={{'textDecoration':"none"}}>
                    <div className="config-container">
                        <div className="config-container-scroll">
            ...
            <div style={{'bottom':"0",'width':"645px", 'height':"55px", 'position':"absolute", 'marginBottom':"108px", 'display': "inline-grid", 'gridTemplateColumns':"336px 103px 103px 103px", 'marginLeft':"-310px"}}>
                ...
                <Link to="/installer-toolbox/system-configuration/wired/edit">
...
export default SystemConfigurationWired