...
function SystemConfigurationKeyfobs(){
    const [Fob_Used,setFob_Used] = useState(`Disabled`)
    const [Equipment_Code,setEquipment_Code] = useState(`0866 - KEY2-345 4-Button Keyfob`)
    ...
    const [Emergency_Key,setEmergency_Key] = useState(`Disabled`)
    const [Fob_Can_Disarm,setFob_Can_Disarm] = useState(`Enabled`)
    const [Voice_Descriptor,setVoice_Descriptor] = useState(`<None>`)
    const [Arm_No_Entry_Delay,setArm_No_Entry_Delay] = useState(`Disabled`)
    const [Fob_Output,setFob_Output] = useState(`Disabled`)
    ...
    function EquipmentCode(){
        ...
        else if (datapass === "2866"){
            setEquipment_Code('2866 - eSeries 4-Button Keyfob Remote')
        }
        else if (datapass === "0866"){
            setEquipment_Code(`0866 - KEY2-345 4 Button Kefob Remote`)
        }
        else if (datapass === "0577"){
            setEquipment_Code(`0577 - Existing Keyfob Remote`)
        }
        else {
            setEquipment_Code(`0000 - Other`)
        }
    ...
    function EmergencyKey(){
        ...
        if (datapass === "enabled"){
            setEmergency_Key(`Enabled`)
        }
        else if(datapass === "disabled"){
            setEmergency_Key(`Disabled`)
        }
        else{
            setEmergency_Key(`Enabled`)
        }
    ...
    function FobCanDisarm(){
        ...
        if(datapass === "enabled"){
           setFob_Can_Disarm(`Enabled`)
        }
        else if(datapass === "disabled"){
            setFob_Can_Disarm(`Disabled`)
        }
        else {
            setFob_Can_Disarm(`Enabled`)
        }
    ...
    function ArmNoEntryDelay(){
        ...
        if (datapass === "enabled"){
            setArm_No_Entry_Delay(`Enabled`)
        }
        else if(datapass === "disabled"){
            setArm_No_Entry_Delay(`Disabled`)
        }
        else{
            setArm_No_Entry_Delay(`Enabled`)
        }
    ...
    function FobOutput(){
        ...
        if (datapass === "toggle"){
            setFob_Output(`Toggle Output`)
        }
        else if(datapass === "momentary"){
            setFob_Output(`Momentary Ouptu`)
        }
        else if(datapass === "disabled"){
            setFob_Output(`Disabled`)
        }
        else{
            setFob_Output(`Disabled`)
        }
    ...
    return(
        <div className="screen-style">
            <div className="screen-header">
                <img src={keyfob_icon} className="resize-1 invert-color" alt="" />
                ...
                <div className="config-container">
                    <div className="config-container-scroll">
                        ...
                        <ul className="programming-list">
                            <li><p id="zone-one" tabIndex="0" onClick={() => choseZone("zone-one")}>Keyfob 1</p></li>
                            <li><p id="zone-two" tabIndex="0" onClick={() => choseZone("zone-two")}>Keyfob 2</p></li>
                            <li><p id="zone-three" tabIndex="0" onClick={() => choseZone("zone-three")}>Keyfob 3</p></li>
                            <li><p id="zone-four" tabIndex="0" onClick={() => choseZone("zone-four")}>Keyfob 4</p></li>
                        </ul>
            ...
            <div className="screen-right-settings">
                <Link to="/installer-toolbox/system-configuration/keyfobs/edit" style={{'textDecoration':"none"}}>
                    <div className="config-container">
                        <div className="config-container-scroll">
                            <ul className="programming-list" style={{'marginTop':"0", 'marginBottom':"0"}}>
                                <li className="programming-right-side-list-option" style={{'borderTop':"none"}}><p style={{'color':"#404956"}}>Fob Used</p><p id="sensor-type" className="css-grid-align-right" style={{'color':"#404956"}}>{Fob_Used}</p></li>
                                ...
                                <li className="programming-right-side-list-option"><p style={{'color':"#404956"}}>Emergency Key</p><p id="sensor-type" className="css-grid-align-right" style={{'color':"#404956"}}>{Emergency_Key}</p></li>
                                <li className="programming-right-side-list-option"><p style={{'color':"#404956"}}>Fob Can Disarm</p><p id="sensor-type" className="css-grid-align-right" style={{'color':"#404956"}}>{Fob_Can_Disarm}</p></li>
                                ...
                                <li className="programming-right-side-list-option"><p style={{'color':"#404956"}}>Arm with No Entry Delay</p><p id="sensor-type" className="css-grid-align-right" style={{'color':"#404956"}}>{Arm_No_Entry_Delay}</p></li>
                                <li className="programming-right-side-list-option"><p style={{'color':"#404956"}}>Fob Output</p><p id="sensor-type" className="css-grid-align-right" style={{'color':"#404956"}}>{Fob_Output}</p></li>
                            </ul>
                        </div>
                    </div>
                </Link>
            ...
            <div style={{'bottom':"0",'width':"645px", 'height':"55px", 'position':"absolute", 'marginBottom':"108px", 'display': "inline-grid", 'gridTemplateColumns':"336px 103px 103px 103px", 'marginLeft':"-310px"}}>
                ...
                <Link to="/installer-toolbox/system-configuration/keyfobs/edit">
...
export default SystemConfigurationKeyfobs