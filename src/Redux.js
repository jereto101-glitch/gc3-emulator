...
const codesReducer = (state = init, action) => {
    ...
    var panelWireless = state.wireless
    var panelWired = state.wired
    ...
    var retrievedWired = localStorage.getItem("panelWired");
    retrievedWired = JSON.parse(retrievedWired)
    ...
    if (retrievedWireless == null){
        localStorage.setItem('panelWireless', JSON.stringify(panelWireless));
    }

    if (retrievedWired == null){
        localStorage.setItem('panelWired', JSON.stringify(panelWired));
    }
