...
var Game = function (_React$Component) {
  ...
  function Game(props) {
    ...
    skyImage.src = require('./images/dino/cloud.png');
    groundImage.src = require('./images/dino/ground.png');
    playerImage.src = require('./images/dino/dinosaur.png');
    playerLeftImage.src = require('./images/dino/dinosaur_left.png');
    playerRightImage.src = require('./images/dino/dinosaur_right.png');
    playerDieImage.src = require('./images/dino/dinosaur_die.png');
    obstacleImage.src = require('./images/dino/obstacle.png');
